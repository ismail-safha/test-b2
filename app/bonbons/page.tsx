...
import { lesenTeil_1 } from "../data/Insekten_H/bonbonsData";
...
const LesenTeil: React.FC = () => {
  ...
  return session ? (
    <div className="container m-auto  w-full px-2">
      <Header
        pageHome="/bonbons"
        pageTow="/bonbons/lesenteil-2"
        pageThree="/bonbons/lesenteil-3"
        pageFour="/bonbons/sprachbauchteine-1"
        pageFive="/bonbons/sprachbauchteine-2"
      />
