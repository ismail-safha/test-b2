...
import { sprachbau_1 } from "../../data/Insekten_H/kaffeeData";
  ...
  return (
    session && (
      <div className="container m-auto  w-full px-2">
        <Header
          pageHome="/kaffee"
          pageTow="/kaffee/lesenteil-2"
          pageThree="/kaffee/lesenteil-3"
          pageFour="/kaffee/sprachbauchteine-1"
          pageFive="/kaffee/sprachbauchteine-2"
        />
        <main>
