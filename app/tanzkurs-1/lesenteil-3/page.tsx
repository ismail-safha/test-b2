...
import { lesenTeil_3 } from "../../data/Insekten_H/tanzkursData-1";
  ...
  return (
    session && (
      <div className="container m-auto  w-full px-2">
        <Header
          pageHome="/tanzkurs-1"
          pageTow="/tanzkurs-1/lesenteil-2"
          pageThree="/tanzkurs-1/lesenteil-3"
          pageFour="/tanzkurs-1/sprachbauchteine-1"
          pageFive="/tanzkurs-1/sprachbauchteine-2"
        />
