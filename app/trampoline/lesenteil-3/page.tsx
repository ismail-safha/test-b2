...
import { lesenTeil_3 } from "../../data/Insekten_H/trampolineData";
  ...
  return (
    session && (
      <div className="container m-auto  w-full px-2">
        <Header
          pageHome="/trampoline"
          pageTow="/trampoline/lesenteil-2"
          pageThree="/trampoline/lesenteil-3"
          pageFour="/trampoline/sprachbauchteine-1"
          pageFive="/trampoline/sprachbauchteine-2"
        />
