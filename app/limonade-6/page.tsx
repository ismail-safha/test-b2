...
import { lesenTeil_1 } from "../data/Insekten_H/limonade-nData-6";
...
const LesenTeil: React.FC = () => {
  ...
  return session ? (
    <div className="container m-auto  w-full px-2">
      <Header
        pageHome="/limonade-6"
        pageTow="/limonade-6/lesenteil-2"
        pageThree="/limonade-6/lesenteil-3"
        pageFour="/limonade-6/sprachbauchteine-1"
        pageFive="/limonade-6/sprachbauchteine-2"
      />
