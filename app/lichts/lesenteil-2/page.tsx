...
import { lesenTeil_2 } from "../../data/Insekten_H/lichtsData";
...
const Lesenteiltow = () => {
  ...
  return (
    session && (
      ...
      <Header
        pageHome="/lichts"
        pageTow="/lichts/lesenteil-2"
        pageThree="/lichts/lesenteil-3"
        pageFour="/lichts/sprachbauchteine-1"
        pageFive="/lichts/sprachbauchteine-2"
      />
        <main>
