...
import { lesenTeil_3 } from "../../data/Insekten_H/grippeData";
  ...
  return (
    session && (
      <div className="container m-auto  w-full px-2">
        <Header
          pageHome="/grippe"
          pageTow="/grippe/lesenteil-2"
          pageThree="/grippe/lesenteil-3"
          pageFour="/grippe/sprachbauchteine-1"
          pageFive="/grippe/sprachbauchteine-2"
        />
