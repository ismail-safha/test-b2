...
import { lesenTeil_3 } from "../../data/Insekten_H/limonade-nData-5";
  ...
  return (
    session && (
      <div className="container m-auto  w-full px-2">
        <Header
          pageHome="/limonade-5"
          pageTow="/limonade-5/lesenteil-2"
          pageThree="/limonade-5/lesenteil-3"
          pageFour="/limonade-5/sprachbauchteine-1"
          pageFive="/limonade-5/sprachbauchteine-2"
        />
